...
<body class="gradient-bg min-h-screen">
    ...
    <section class="relative py-32 px-4 overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto text-center">
            ...
            <section class="relative py-24 overflow-hidden mb-20">
                <div class="absolute inset-0 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50"></div>
                <div class="absolute inset-0 bg-gradient-to-t from-orange-100/30 to-transparent"></div>
                ...
                <div class="relative max-w-6xl mx-auto px-4 text-center">
                    <div class="animate-fade-in-up">
                        <!-- Header Badge -->
                        <div class="mb-16">
                            <div class="inline-flex items-center gap-3 glass-effect rounded-full px-8 py-4 shadow-xl mb-8 bg-white/40 backdrop-blur-sm border border-orange-200/50">
                                <svg class="w-8 h-8 text-orange-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                                <span class="text-orange-600 font-bold uppercase tracking-wider text-lg">Success Stories</span>
                            </div>
                            
                            <h1 class="text-5xl md:text-6xl lg:text-7xl font-black mb-8">
                            ...
                            <p class="text-xl md:text-2xl text-slate-700 leading-relaxed max-w-4xl mx-auto mb-12">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-200/50 hover-lift">
                                <div class="text-4xl md:text-5xl font-black text-orange-600 mb-3">200+</div>
                                <div class="text-slate-700 font-semibold text-lg">Happy Adoptions</div>
                            </div>
                            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-200/50 hover-lift">
                                <div class="text-4xl md:text-5xl font-black text-amber-600 mb-3">50+</div>
                                <div class="text-slate-700 font-semibold text-lg">Loving Families</div>
                            </div>
                            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-200/50 hover-lift">
                                <div class="text-4xl md:text-5xl font-black text-yellow-600 mb-3">98%</div>
                                <div class="text-slate-700 font-semibold text-lg">Success Rate</div>
                            </div>
                            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-200/50 hover-lift">
                                <div class="text-4xl md:text-5xl font-black text-orange-600 mb-3">5+</div>
                                <div class="text-slate-700 font-semibold text-lg">Years of Service</div>
                            </div>
                        </div>
                    </div>
                </div>
