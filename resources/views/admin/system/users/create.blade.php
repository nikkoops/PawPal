        ...
        <form action="{{ route('admin.system.users.store') }}" method="POST">
            ...
            <div class="mb-6" id="shelterLocationField" style="display: none;">
                ...
                <select 
                    ...
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('shelter_location') border-red-500 @enderror"
                >
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleShelterLocation() {
            ...
            if (selectedRole === 'shelter_admin') {
                ...
                emailInput.classList.remove('focus:ring-2', 'focus:ring-purple-500');
                ...
                emailInput.classList.add('focus:ring-2', 'focus:ring-purple-500', 'focus:border-transparent');
