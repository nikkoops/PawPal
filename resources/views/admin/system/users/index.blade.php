...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.system.users.create') }}" class="bg-orange-600 hover:bg-[#c1431d] text-white font-medium px-6 py-3 rounded-lg transition duration-200 flex items-center">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                @if($user->email !== 'admin@pawpal.com')
                                    <a href="{{ route('admin.system.users.edit', $user) }}" class="text-orange-600 hover:text-purple-900 mr-3">
                                        Edit
                                    </a>
                                @endif
                                @if($user->id !== auth()->id())
